...
export default class WallpaperSetter {
  ...
  async setWallpaper(wallpaperName) {
    // Pełna ścieżka do wybranej tapety
    const wallpaperDir = `${USER_ARGUMENTS.wallpapersDirectory}/${wallpaperName}`;
  
    // 1. Upewniamy się, że istnieje katalog ~/.cache/WallRizz
    ...
    // 2. Zapisujemy ścieżkę do pliku current_wallpaper
    ...
    // 3. Wywołujemy oryginalną logikę: ustawianie tapety i powiadomienie
