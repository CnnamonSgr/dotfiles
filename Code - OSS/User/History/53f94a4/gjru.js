...
export default class WallpaperSetter {
  ...
  async setWallpaper(wallpaperName) {
    ...
    // Saves current wallpaper to the ~/.cache/WallRizz/current_wallpaper location
    fs.writeFileSync(`${process.env.HOME}/.cache/WallRizz/current_wallpaper`, wallpaperDir);
